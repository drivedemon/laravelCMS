    ...
    <div class="container text-center">
      <div class="row h-100">
        <div class="col-lg-8 mx-auto align-self-center">
          ...
          <p><span class="opacity-70 mr-1">By</span> <a class="text-white" href="{{route('blog.postuser', $post->id)}}">{{$post->user->name}}</a></p>
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          var disqus_config = function () {
            this.page.url = "{{config('app.url')}}/blog/post/{{$post->id}}";  // comment จะแสดงอยู่ในบทความนั้นๆ
            this.page.identifier = "{{$post->id}}"; // comment ที่บ่งบอกว่าเป็น comment ของ post ไหน
          };
          (function() { // DON'T EDIT BELOW THIS LINE
            var d = document, s = d.createElement('script');
            s.src = 'https://http-localhost-8000-iwgniiph4o.disqus.com/embed.js';
